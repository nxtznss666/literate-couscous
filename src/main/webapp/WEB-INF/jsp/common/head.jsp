...
<!--时间-->
 ...
 <section class="publicMian ">
     <div class="left">
         ...
         <nav>
             <ul class="list">
                 <li ><a href="${pageContext.request.contextPath }/bill/showBillList.html">订单管理</a></li>
              <li><a href="${pageContext.request.contextPath }/provider/showProvider.html">供应商管理</a></li>
